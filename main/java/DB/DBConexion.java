...
public class DBConexion extends SQLiteOpenHelper {
    ...
    private static final int DB_VERSION = 1;  // par cambiar las versiones se cambia por el numero ss
    public static final String TABLA_CONTACTOS = "contactos";
    public static final String CONTACTO_ID = "-id";
    public static final String CONTACTO_NOMBRE = "nombre";
    public static final String CONTACTO_TLFN = "tlfn";
    public static final String CONTACTO_EMAIL = "email";
    public static final String SENTENCIA_CREACION_TABLA_CONTACTOS = "create table contactos" +
            "(_id integer not null,nombre text not null, teléfono text not null, email text not null)";
    ...
    public ArrayList selectContactos(SQLiteDatabase db) {
        ...
        Cursor c = db.rawQuery(SENTENCIA_ACTUALIZACION_TABLA_CONTACTOS, null);

        if(c.moveToFirst()){
            //Es un fetch Array lo utilizamos
            do{
                //@SuppressLint("Range")
