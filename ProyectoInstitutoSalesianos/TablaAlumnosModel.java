...
//        alumnos.add(a5);
    ...
    @Override
    public Object getValueAt(int fila, int columna) { //este es eñ que pinta, es decir los datos de la BBDD, puede ser porque el select value as no este bien o por que no
        //se utilice bien el getValue
